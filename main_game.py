...
class GameScene(Scene):
    def setup(self):
        ...
        self.ship = SpriteNode('spc:PlayerShip3Blue')
    ...
    def update(self):
        ...
        if self.score == - 20 :
            ...
            self.alien_attack_speed = self.alien_attack_speed + 5
    ...
    def create_new_lasers(self):
        ...
        lasers_start_position.x = self.spaceship.position.x
        lasers_start_position.y = 100
        
        lasers_end_position = Vector2()
        lasers_end_position.x = missile_start_position.x
        lasers_end_position.y = self.size_of_screen_y + 100
    ...
    def add_alien(self):
        ...
        self.aliens.append(SpriteNode('spc:EnemyBlue4',
